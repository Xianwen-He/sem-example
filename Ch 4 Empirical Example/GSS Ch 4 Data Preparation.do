...
*** Author: S Bauldry
*** Date: March 5, 2013
*** Updated on June 7, 2022 by X.H.


*** Setting working directory
cd "\\Client\D$\Documents\SEM\CH4\Ch 4 Empirical Example"
...
use id sex educ paeduc maeduc papres80 mapres80 age hispanic racecen1 ///
    sibs happy family16 paocc maocc prestg80 happy class health health1 ///
	using gss2010merged_r2b, replace
    
*** Preparing sex and race
gen female = (sex == 2)
...
qui tab race, gen(r)
rename (r2 r3 r4 r5) (black asian hispanic othrace)
...
*** Just keeping cases with complete data for covariates
drop if mi(prestg80, educ, paeducM, maeducM, papr80M, mapr80M, age, ///
           lnsibs, female, race)

*** Saving data for analysis in Mplus
keep id happy class health health1 paeducM maeducM paNOeduc maNOeduc ///
  papr80M mapr80M age lnsibs female black asian hispanic othrace ///
  napaeduc namaeduc napapr80 namapr80 educ prestg80
foreach x of varlist _all {
	replace `x' = -999 if mi(`x')
}
desc
outsheet using GSS_Ordinal_Mplus.txt, replace comma noname nolabel
